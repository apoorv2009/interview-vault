...
*For deep technical fluency on the modernization topics below (Strangler pattern, AngularJS→Angular mechanics, ASP.NET Core migration, Azure service selection, observability, CI/CD, security) beyond what fits in a spoken story, see the `enterprise-modernization/` folder — generic technical reference and a 75-question deep-dive bank, not tied to a specific claimed incident.*
...
*This is the real Wipro Cloud Migration Programme story, confirmed against my resume (Application Architect, Wipro, Mar 2022–Nov 2024) — full technical mechanics reference in `enterprise-modernization/01-03` in this vault.*
